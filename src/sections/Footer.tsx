    ...
    <footer className="bg-stone-900 text-white" id="contact">
      <div className="container">
        <div className="section">
          <div className="flex items-center gap-3">
            ...
            <span className="uppercase">
              One spot available for new projects. Get in touch today!
            </span>
          </div>
              ...
              <Button
                ...
                iconAfter={
                  <div className="size-6 overflow-hidden">
                    <div
                      className="flex group-hover/button:-translate-x-1/2
                     w-12 gap-0.5 h-6 transition-transform duration-300"
                    >
                      <svg
        ...
        <p className="py-16 text-white/30 text-sm">
          Copyright &copy; Wisdom Mpamugo &bull; All rights reserved.
        </p>
      </div>
    </footer>
  );
